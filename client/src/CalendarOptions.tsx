...
function CalendarOptions(props: {calendar?: CalendarInfo, open: boolean, close: () => void}) {
  ...
  return (
    <Dialog fullScreen open={props.open}>
      ...
      <Container maxWidth="md" sx={{marginBlockStart: "75px", marginBlockEnd: "75px"}}>
        <Container sx={{marginBlock: "24px"}}>
        ...
        <Container sx={{marginBlockStart: "24px"}}>
          <FormControl component="fieldset" variant="standard" fullWidth>
        ...
        <Container sx={{marginBlock: "24px"}}>
          <FormControl component="fieldset" variant="standard" fullWidth>
            ...
            <FormGroup>
              ...
              <ButtonGroup sx={{paddingBlockStart: "8px"}}>
